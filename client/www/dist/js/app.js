                    ...
                    events: {
                        onStateChange: function(event) {
                            ...
                            switch (event.data) {
                                case 0:
                                    // Ended
                                    theme('#content{background-image:url("/img/desktop/logo.png"), url("/img/desktop/bg.png");} #bonzi_tv_yt{background-image:url("/img/desktop/logo.tv.png"), url("/img/desktop/bg.png"); background-position: top left, center; background-repeat: no-repeat;}')
